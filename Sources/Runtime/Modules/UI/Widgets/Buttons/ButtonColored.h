...
namespace LittleEngine::UI::Widgets::Buttons
{
	...
	*/
	...
	public:
		...
		* @param p_enableAlpha
		*/
		ButtonColored(const std::string& p_label = "", const Types::Color& p_color = {}, const LittleEngine::FVector2& p_size =LittleEngine::FVector2(0.f, 0.f), bool p_enableAlpha = true);
