...
namespace LittleEngine
{
    ...
    public:
        ...
        static std::string Replace(const std::string& source_string,const  std::string& sub_string, const std::string& new_string);
        static std::string Replace(const std::string& source_string, char taget_char, const char new_char);
